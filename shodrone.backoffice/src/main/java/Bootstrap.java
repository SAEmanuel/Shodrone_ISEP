...
public class Bootstrap implements Runnable {
    ...
    private final Figure figure2 = new Figure(new domain.valueObjects.Name("Airplane"), new Description("A fixed-wing flying vehicle"), 2L, category2, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.pdf"), customer3);
    private final Figure figure3 = new Figure(new domain.valueObjects.Name("Tree"), new Description("A tall plant with a trunk"), 3L, category3, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer1);
    private final Figure figure4 = new Figure(new domain.valueObjects.Name("Robot"), new Description("A programmable machine"), 4L, category4, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("input.txt"), customer2);
    private final Figure figure5 = new Figure(new domain.valueObjects.Name("Spiral"), new Description("A curve that winds around a center point"), 5L, category5, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer2);
    private final Figure figure6 = new Figure(new domain.valueObjects.Name("Cat"), new Description("A domestic feline animal"), 6L, category6, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.pdf"), customer3);
    private final Figure figure7 = new Figure(new domain.valueObjects.Name("Guitar"), new Description("A stringed musical instrument"), 7L, category7, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("input.txt"), customer1);
    private final Figure figure8 = new Figure(new domain.valueObjects.Name("Football"), new Description("A classic soccer ball"), 8L, category8, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer3);
    private final Figure figure9 = new Figure(new domain.valueObjects.Name("Rocket"), new Description("A vehicle propelled by rocket engines"), 9L, category9, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.pdf"), customer1);
    private final Figure figure10 = new Figure(new domain.valueObjects.Name("Car"), new Description("A four-wheeled motor vehicle"), 10L, category10, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("input.txt"), customer2);
    private final Figure figure11 = new Figure(new domain.valueObjects.Name("Pizza"), new Description("A slice of Italian pizza"), 11L, category11, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer2);
    private final Figure figure12 = new Figure(new domain.valueObjects.Name("Runner"), new Description("A person running"), 12L, category12, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.pdf"), customer3);
    private final Figure figure13 = new Figure(new domain.valueObjects.Name("House"), new Description("A simple house with a roof"), 13L, category13, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("input.txt"), customer2);
    private final Figure figure14 = new Figure(new domain.valueObjects.Name("Heart"), new Description("A classic symbol of love"), 14L, category14, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.pdf"), customer1);
    private final Figure figure15 = new Figure(new domain.valueObjects.Name("Cloud"), new Description("A visible mass of condensed water vapor"), 15L, category15, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer3);
    private final Figure figure16 = new Figure(new domain.valueObjects.Name("Flower"), new Description("A colorful part of a plant"), 16L, category16, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("input.txt"), customer1);
    private final Figure figure17 = new Figure(new domain.valueObjects.Name("Dragon"), new Description("A mythical fire-breathing creature"), 17L, category17, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer2);
    private final Figure figure18 = new Figure(new domain.valueObjects.Name("Christmas Tree"), new Description("A decorated pine for Christmas"), 18L, category18, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("input.txt"), customer3);
    private final Figure figure19 = new Figure(new domain.valueObjects.Name("Fish"), new Description("A typical sea fish"), 19L, category19, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.pdf"), customer1);
    private final Figure figure20 = new Figure(new domain.valueObjects.Name("Smiley"), new Description("A classic smiling emoji face"), 20L, category20, FigureAvailability.PUBLIC, FigureStatus.ACTIVE, new DSL("drones.txt"), customer2);
