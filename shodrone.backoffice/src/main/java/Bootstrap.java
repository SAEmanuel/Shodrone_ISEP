...
public class Bootstrap implements Runnable {
    ...
    private final Figure figure3  = new Figure("Tree",           new Description("A tall plant with a trunk"),             3L,  category3,  FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer1);
    private final Figure figure4  = new Figure("Robot",          new Description("A programmable machine"),                4L,  category4,  FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer1);
    private final Figure figure5  = new Figure("Spiral",         new Description("A curve that winds around a center point"), 5L, category5,  FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer1);
    private final Figure figure6  = new Figure("Cat",            new Description("A domestic feline animal"),              6L,  category6,  FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer1);
    private final Figure figure7  = new Figure("Guitar",         new Description("A stringed musical instrument"),         7L,  category7,  FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer1);
    private final Figure figure8  = new Figure("Football",       new Description("A classic soccer ball"),                 8L,  category8,  FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer1);
    ...
    private final Figure figure11 = new Figure("Pizza",          new Description("A slice of Italian pizza"),             11L,  category11, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer2);
    private final Figure figure12 = new Figure("Runner",         new Description("A person running"),                     12L,  category12, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer2);
    private final Figure figure13 = new Figure("House",          new Description("A simple house with a roof"),           13L,  category13, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer2);
    private final Figure figure14 = new Figure("Heart",          new Description("A classic symbol of love"),             14L,  category14, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer2);
    private final Figure figure15 = new Figure("Cloud",          new Description("A visible mass of condensed water vapor"), 15L, category15, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer2);
    ...
    private final Figure figure18 = new Figure("Christmas Tree", new Description("A decorated pine for Christmas"),       18L,  category18, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer3);
    private final Figure figure19 = new Figure("Fish",           new Description("A typical sea fish"),                   19L,  category19, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer3);
    private final Figure figure20 = new Figure("Smiley",         new Description("A classic smiling emoji face"),         20L,  category20, FigureAvailability.EXCLUSIVE, FigureStatus.ACTIVE, customer3);
