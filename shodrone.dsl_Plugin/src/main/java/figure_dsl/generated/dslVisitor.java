...
public interface dslVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link dslParser#block_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBlock_statement(dslParser.Block_statementContext ctx);
	/**
	 * Visit a parse tree produced by {@link dslParser#unscoped_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnscoped_statement(dslParser.Unscoped_statementContext ctx);
	/**
